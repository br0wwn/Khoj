  ...
  if (variant === 'list') {
    ...
    return (
      <div className="relative">
        ...
        {/* Only show report button if user is not the creator */}
        {user && alert.createdBy && alert.createdBy.userId &&
          String(alert.createdBy.userId._id || alert.createdBy.userId) !== String(user.id) && (
