...
const chatController = require('../controllers/GrpchatController');
...
// PROTECTED: POST join group (without invitation)
...
router.post('/:groupId/messages', requireAuth, chatMediaUpload.single('media'), chatController.grpSendMessage);
